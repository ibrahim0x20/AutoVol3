...
class AutoVol3(object):
    ...
    def initialize_normal_proc(self, normal_proc_file):     # Change name to intialize_process_spawning
    ...
    def malproc(self,node):
        ...
        # 2. Should find zero parent processes                                      find_processes_without_parents()                ==> Done
        # 3. Should find processes running from weired locations such as unusal directories or temp folders         def malpath()   ==> Done
        # 4. Should find hidden/Unlinked processes like processes found in psscan, but not in pslist                    ==> Done
        ...
        # 7. Should find processes that don't match legitimate software
        # 8. Should find processes that are not digitally signed and verified
        # 9. Should find high privilege processes
        ...
        # 12. Known Malware Indicator: matching process names, file hashes, or network connections to know malware database
        # 13. Suspecious Command Line Arguments
        # 14. Should find processes running from cmd.exe or powershell.exe
...
if __name__ == "__main__":
    ...
    # Add option for project directory
